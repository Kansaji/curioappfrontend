...
export class AdvertisementService {
  ...
  postAdvertisement(advertisementPayload:AdvertisementPayload){
    return this.httpClient.post("http://localhost:8080/api/ads/",advertisementPayload);
  }

  getAllAdvertisements():Observable<Array<AdvertisementPayload>>{
    return this.httpClient.get<Array<AdvertisementPayload>>("http://localhost:8080/api/ads/allads");
  }
}
